...
public class MemDaoImp implements MemDAO {
	/**
	 * maven repository dependency 추가해야 import 가능
	 *   - org.mybatis & "org.mybatis.mybatis-org" jar
	 */
	private SqlSessionTemplate sqlSession;
	
	public MemDaoImp() {}
	
	// setter (jdbc.xml에서 의존성 주입)
	...
	public void updateMethod(MemDTO dto) {
		sqlSession.update("mem.update", dto);		
	}
	...
	public void deleteMethod(int num) {
		sqlSession.delete("mem.delete", num);
	}
